export default {
  'en-us': {
    ...
    list: [
        {   title: 'Nacos 1.2.0-beta.0发布，支持权限控制',
            author: '@敦谷',
            dateStr: 'Feb 5th, 2020',
            desc: 'Nacos是阿里巴巴开源的服务发现与配置管理项目，本次发布的1.2.0-beta.0版本，主要带来的是权限控制',
            link: '/en-us/blog/nacos 1.2.0-beta.0.html',
        },
        {   title: 'Nacos权限控制设计方案',
            author: '@敦谷',
            dateStr: 'Dec 19, 2019',
            desc: 'Nacos自开源以来，权限控制一直需求比较强烈，这也反应了用户需求将Nacos部署到生产环境的需求。',
  ...
  'zh-cn': {
    ...
    list: [
        {   title: 'Nacos 1.2.0-beta.0发布，支持权限控制',
            ...
            dateStr: 'Feb 5th, 2020',
            desc: 'Nacos是阿里巴巴开源的服务发现与配置管理项目，本次发布的1.2.0-beta.0版本，主要带来的是权限控制',
            link: '/zh-cn/blog/nacos 1.2.0-beta.0.html',
        },
        {   title: 'Nacos权限控制设计方案',
            author: '@敦谷',
            dateStr: 'Dec 19, 2019',
            desc: 'Nacos自开源依赖，权限控制一直需求比较强烈，这也反应了用户需求将Nacos部署到生产环境的需求。',
            link: '/zh-cn/blog/access control design.html',
        },
        {   title: '命名空间和endpoint最佳实践',
            author: '@得少',
            dateStr: 'Dec 6, 2019',
