    ...
    t.default = {
        "en-us": {
            brand: {
                ...
                versionNote: {
                    text: "Release Note of V1.2.1",
                    link: "https://github.com/alibaba/nacos/releases/tag/1.2.1"
                },
                releaseDate: "Released on Mar 31, 2020"
            },
            functions: {
                title: "Features",
                list: [{
        ...
        "zh-cn": {
            brand: {
                ...
                versionNote: {text: "V1.2.1 版本说明", link: "https://github.com/alibaba/nacos/releases/tag/1.2.1"},
                releaseDate: "2020年03月31日发布"
            },
            functions: {
                title: "功能",
                list: [{
