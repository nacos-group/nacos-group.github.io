!function (e) {
    ...
    var m, g, y, h, v, b, w = n(8),
        ...
        }, j = Object.defineProperty, O = Object.getOwnPropertyDescriptor, _ = Object.getOwnPropertyNames,
...
*/
        ...
        return function (e) {
            ...
            function u(e) {
                ...
                if ("function" == typeof B) {
                    ...
                    !R && Array.isArray(e) || B.apply(void 0, n), Array.isArray(e) && e.forEach(function (e) {
            ...
            function c(e, t) {
                ...
                t && (t.debug && !0 === t.debug && (q = !0), !1 === t.titleCase && (z = !1)), t && t.gaOptions ? B("create", e, t.gaOptions) : B("create", e, "auto")
            }

            function l(e, t) {
                if (t && !0 === t.testMode) I = !0; else {
            ...
            function s() {
                for (var e = arguments.length, t = Array(e), n = 0; n < e; n++) t[n] = arguments[n];
                return t.length > 0 && (B.apply(void 0, t), q && ((0, C.default)("called ga('arguments');"), (0, C.default)("with arguments: " + JSON.stringify(t)))), window.ga
            }

            function f(e, t) {
                return e ? "object" !== (void 0 === e ? "undefined" : w(e)) ? void(0, A.default)("Expected `fieldsObject` arg to be an Object") : (0 === Object.keys(e).length && (0, A.default)("empty `fieldsObject` given to .set()"), u(t, "set", e), void(q && ((0, C.default)("called ga('set', fieldsObject);"), (0, C.default)("with fieldsObject: " + JSON.stringify(e))))) : void(0, A.default)("`fieldsObject` is required in .set()")
            }

            function d(e, t) {
                u(t, "send", e), q && ((0, C.default)("called ga('send', fieldObject);"), (0, C.default)("with fieldObject: " + JSON.stringify(e)), (0, C.default)("with trackers: " + JSON.stringify(t)))
            }
            ...
            function m(e, t) {
                ...
                var n = (0, _.default)((0, S.default)(e));
                if ("" === n) return void(0, A.default)("modalName cannot be an empty string or a single / in .modalview()");
                if ("function" == typeof s) {
                    var r = "/modal/" + n;
                    u(t, "send", "pageview", r), q && ((0, C.default)("called ga('send', 'pageview', path);"), (0, C.default)("with path: " + r))
                }
            }
            ...
            var k = n(3), j = r(k), O = n(6), _ = r(O), E = n(1), S = r(E), x = n(7), P = r(x), N = n(0), A = r(N),
                T = n(8), C = r(T), D = n(9), M = r(D), X = n(10), L = r(X), q = !1, z = !0, I = !1, R = !0,
                B = function () {
                    var e;
                    return I ? M.default.ga.apply(M.default, arguments) : window.ga ? (e = window).ga.apply(e, arguments) : (0, A.default)("ReactGA.initialize must be called first or GoogleAnalytics should be loaded manually")
                }, F = t.plugin = {
                    require: function (e, t) {
                        if ("function" == typeof s) {
                            ...
                            if (t) {
                                ...
                                0 === Object.keys(t).length && (0, A.default)("Empty `options` given to .require()"), s("require", n, t), q && (0, C.default)("called ga('require', '" + n + "', " + JSON.stringify(t))
                            } else s("require", n), q && (0, C.default)("called ga('require', '" + n + "');")
                        }
                        ...
                        if (1 == (arguments.length <= 2 ? 0 : arguments.length - 2) ? n = arguments.length <= 2 ? void 0 : arguments[2] : (r = arguments.length <= 2 ? void 0 : arguments[2], n = arguments.length <= 3 ? void 0 : arguments[3]), "function" == typeof s) if ("string" != typeof e) (0, A.default)("Expected `pluginName` arg to be a String."); else if ("string" != typeof t) (0, A.default)("Expected `action` arg to be a String."); else {
                            var a = e + ":" + t;
                            n = n || null, r && n ? (s(a, r, n), q && ((0, C.default)("called ga('" + a + "');"), (0, C.default)('actionType: "' + r + '" with payload: ' + JSON.stringify(n)))) : n ? (s(a, n), q && ((0, C.default)("called ga('" + a + "');"), (0, C.default)("with payload: " + JSON.stringify(n)))) : (s(a), q && (0, C.default)("called ga('" + a + "');"))
                        }
                    }
                };
            L.default.origTrackLink = L.default.trackLink, L.default.trackLink = v;
            var K = t.OutboundLink = L.default;
    ...
    t.default = {
        "en-us": {
            brand: {
                ...
                versionNote: {
                    text: "Release Note of V2.0.0",
                    link: "https://github.com/alibaba/nacos/releases/tag/2.0.0-bugfix"
                },
                versionNote2: {text: "V2.0.0", link: "https://github.com/alibaba/nacos/releases/tag/2.0.0-bugfix"},
        ...
        "zh-cn": {
            brand: {
                ...
                versionNote: {text: "V2.0.0 版本说明", link: "https://github.com/alibaba/nacos/releases/tag/2.0.0-bugfix"},
                versionNote2: {text: "V2.0.0", link: "https://github.com/alibaba/nacos/releases/tag/2.0.0-bugfix"},
    ...
    var u = function () {
        ...
        v = r(h), b = n(9), w = r(b), k = n(37), j = r(k), O = n(75), _ = r(O), E = n(74), S = r(E), x = n(64),
        P = r(x);
    n(80);
    var N = function (e) {
        function t(e) {
        ...
        return i(t, e), u(t, [{
            ...
            key: "render", value: function () {
                ...
                return l.default.createElement("div", {className: "home-page"}, l.default.createElement("section", {
                ...
                }, a.brand.versionNote.text), l.default.createElement("a", {
                    target: "_blank",
                    rel: "noopener noreferrer",
                    href: (0, d.getLink)(a.brand.versionNote2.link)
                }, a.brand.versionNote2.text)), l.default.createElement("div", {className: "release-date"}, a.brand.releaseDate)), l.default.createElement("div", {className: "animation animation1"}), l.default.createElement("div", {className: "animation animation2"}), l.default.createElement("div", {className: "animation animation3"}), l.default.createElement("div", {className: "animation animation4"}), l.default.createElement("div", {className: "animation animation5"})), l.default.createElement("section", {className: "function-section"}, l.default.createElement("h3", null, a.functions.title), l.default.createElement(j.default, {type: "dark"}), l.default.createElement("div", null, a.functions.list.map(function (e, t) {
                    return l.default.createElement(_.default, {func: e, key: t, imgFirst: t % 2 == 0})
                    ...
                    return l.default.createElement("div", {
                        className: "user-item",
                        key: t
                    }, l.default.createElement("img", {src: e}))
