    ...
    t.default = {
        "en-us": {
            brand: {
                ...
                versionNote: {
                    text: "Release Note of V1.3.0-beta.0",
                    link: "https://github.com/alibaba/nacos/releases/tag/1.3.0-beta"
                },
                releaseDate: "Released on May 15, 2020"
            },
            functions: {
                title: "Features",
                list: [{
        ...
        "zh-cn": {
            brand: {
                ...
                versionNote: {text: "V1.3.0-beta.0 版本说明", link: "https://github.com/alibaba/nacos/releases/tag/1.3.0-beta"},
                releaseDate: "2020年05月15日发布"
            },
            functions: {
                title: "功能",
                list: [{
