...
[zip包](https://github.com/alibaba/nacos/releases/download/0.6.0/nacos-server-0.6.0.zip)

[tar.gz包](https://github.com/alibaba/nacos/releases/download/0.6.0/nacos-server-0.6.0.tar.gz)
