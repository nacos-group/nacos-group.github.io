...
cd nacos/distribution/target/nacos-server-0.6.0/nacos/bin
```

### Download Compressed Packet after Compilation
Download address

[zip package](https://github.com/alibaba/nacos/releases/download/0.6.0/nacos-server-0.6.0.zip)

[tar.gz package](https://github.com/alibaba/nacos/releases/download/0.6.0/nacos-server-0.6.0.tar.gz)


```bash
  unzip nacos-server-0.6.0.zip 或者 tar -xvf nacos-server-0.6.0.tar.gz
  cd nacos/bin
```
