export default {
	...
	'home.description': 'Nacos 是动态服务发现、配置管理和服务管理的解决方案，旨在帮助开发者构建和维护云原生应用 => Nacos 通过提供简单易用的动态服务发现、服务配置、服务共享与管理等服务基础设施，帮助用户在云原生时代，在私有云、混合云或者公有云等所有云环境中，更好的构建、交付、管理自己的微服务平台，更快的复用和组合业务服务，更快的交付商业创新的价值，从而为用户赢得市场。',
	...
	'home.features.2.explain': '动态服务发现对以服务为中心的（例如微服务和云原生）应用架构方式非常关键。Nacos支持DNS-Based和RPC-Based（Dubbo、gRPC）模式的服务发现。Nacos也提供实时健康检查，以防止将请求发往不健康的主机或服务实例。借助Nacos，您可以更容易地为您的服务实现断路器。',
	'home.features.3.title': '3.',
	'home.features.3.summary': '动态 DNS 服务',
	'home.features.3.explain': '通过支持权重路由，动态DNS服务能让您轻松实现中间层负载均衡、更灵活的路由策略、流量控制以及简单数据中心内网的简单DNS解析服务。动态DNS服务还能让您更容易地实现以DNS协议为基础的服务发现，以消除耦合到厂商私有服务发现API上的风险。',
	...
	'cloud.feedback.soul.description': "我们通过 MSE 云原生网关，将流量、安全、微服务网关三合一，大幅降低请求链路条数、降低架构复杂度、运维和故障排查成本，例如降低整个链路 RT 峰值从500ms下降至峰值50ms，服务发布期间502降为0，499平均降低10%等。",
	...
	'cloud.feedback.ykc.description': "于 MSE 全链路灰度，我们得到的收益是很明显的，因应用变更导致的生产事故降低了70%以上，云快充接入的电桩数量完成了20万到30万的增长过程中，平均需求迭代周期从7人日降低到4人日，极大地促进了业务的快速迭代。",
	'cloud.feedback.bosideng.name': '波司登',
	'cloud.feedback.bosideng.description': '我们基于 ACK + MSE + ARMS + Prometheus 支撑了在线业务百万级并发大流量，并帮助业务迭代效率提升2倍，因应用变更导致的生产事故也降低了70%。',
