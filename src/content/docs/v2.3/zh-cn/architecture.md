---
title: Nacos 架构
keywords: [Nacos, 架构, 服务注册中心, 服务元数据, 服务提供方, 服务消费方, 配置管理, 名字服务, 配置服务, 逻辑架构, 领域模型, 类视图, 部署启动模式]
description: Nacos作为服务与配置管理平台，提供服务注册发现、配置与元数据管理，支持多服务生态，含服务注册中心与配置管理模块，强调动态配置与版本控制，逻辑架构含服务、配置、元数据管理等，具备领域模型与多部署模式，满足云集成与多样化需求。
---
