...
您可以通过Nacos的[版本下载页面](/download/nacos-server/)、[release notes](https://github.com/alibaba/nacos/releases) 及 [发布声明](/news/release/)中找到每个版本支持的功能的介绍，`3.0.0`还处于Alpha阶段，推荐在测试环境中使用，生产环境当前推荐的稳定版本为`2.4.3`.

> 注意：Nacos 3.0.0-ALPHA 版本暂不支持从旧版本升级，升级会导致旧配置无法获取和查看。
