...
```shell
curl -X GET '127.0.0.1:8080/v3/console/ai/mcp?namespaceId=nacos-default-mcp&mcpName=test'
```
* 返回示例
...
```shell
curl -X DELETE '127.0.0.1:8080/v3/console/ai/mcp?namespaceId=nacos-default-mcp&mcpName=test'
```
* 返回示例
...
```shell
curl -X GET '127.0.0.1:8080/v3/console/ai/mcp/list?pageNo=1&pageSize=100&namespaceId=nacos-default-mcp&search=blur'
```
* 返回示例
