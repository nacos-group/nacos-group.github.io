...
You can find the features supported by each version through Nacos's [version download page](/download/nacos-server/), [release notes](https://github.com/alibaba/nacos/releases), and [release announcements](/news/release/). The currently recommended stable version for production environments is `3.2.2`.
