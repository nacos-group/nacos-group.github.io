...
Before using Nacos CLI, please ensure your Nacos server is running properly. If you haven't installed Nacos yet, please refer to [Nacos Quick Start](https://nacos.io/docs/latest/quickstart/quick-start/) for installation and startup.
