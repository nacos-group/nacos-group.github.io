...
* **Dynamic configuration management**
    ...
    Nacos provides an easy-to-use UI ([DEMO](http://console.nacos.io/), default username and password is `nacos/nacos@demo`) to help you manage all of your application or services's configurations. It provides some out-of-box features including configuration version tracking, canary/beta release, configuration rollback, and client configuration update status tracking to ensure the safety and control the risk of configuration change.
