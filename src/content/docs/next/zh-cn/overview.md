---
title: Nacos 概览
keywords: [Nacos, 服务发现, 配置管理, AI 管理中心]
...
更完整的 AI 管理中心全景、MCP 管理展开说明和各资源的使用入口，请阅读 [AI 管理中心概述](./manual/user/ai/ai-registry-overview.md)。
...
![Nacos 生态组件](/img/doc/overview/ecology-structure.png)
...
- 接入 AI 管理中心：阅读 [AI 管理中心概述](./manual/user/ai/ai-registry-overview.md)。
