...
您可以通过Nacos的[版本下载页面](/download/nacos-server/)、[release notes](https://github.com/alibaba/nacos/releases) 及 [发布声明](/news/release/)中找到每个版本支持的功能的介绍，生产环境当前推荐的稳定版本为`3.1.1`.
...
> 更多用法请参考 [使用 nacos-setup 一键部署](https://nacos.io/docs/latest/manual/admin/deployment/deployment-nacos-setup/)。
