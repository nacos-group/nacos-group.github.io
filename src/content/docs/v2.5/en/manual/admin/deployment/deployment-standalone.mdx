...
keywords: [Nacos,Deployment,Standalone mode]
description: Nacos Standalone Deployment Guide, This document provides references for deploying Nacos in standalone mode using various methods.
sidebar:
  order: 2
---
