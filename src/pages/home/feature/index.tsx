  ...
  list: [
    ...
    },
    {
      ...
      content: [
        translate({
          ...
          message: '无缝支持Kubernetes和Spring Cloud',
        }),
        <br />,
        translate({
    ...
    },
    {
      ...
      content: [
        ...
        <br />,
        translate({
          id: 'homepage.featureListContent8',
          message:
            '支持具有数百万服务的大规模场景',
        }),
        <br />,
        translate({
          id: 'homepage.featureListContent9',
          message:
            '具备企业级SLA的开源产品',
        }),
      ],
    },
    {
      ...
      content: [
        translate({
          id: 'homepage.featureListContent10',
          message: '支持限流、大促销预案和异地多活',
        }),
        <br />,
        translate({
          id: 'homepage.featureListContent11',
          message:
            '直接支持或稍作扩展即可支持大量有用的互联网应用场景',
        }),
        <br />,
        translate({
          id: 'homepage.featureListContent12',
          message:
            '流量调度和服务治理',
        }),
      ],
