export default {
  "openapi": "3.1.0",
  "info": {
    "title": "Nacos Console API",
    "description": "Nacos Console API openAPI(swagger) type document",
    "license": {
      "name": "Apache 2.0",
  ...
  "tags": [
    {
      "name": "Nacos Console Naming Center Service Related APIs",
      "description": "Operations related to services in the Nacos Console Naming Center, including creating/deleting services, listing services, retrieving service details, querying service subscribers, and more."
    },
    {
      "name": "Nacos Console Namespace APIs",
      "description": "Routines to manage namespaces in the Nacos console: list, retrieve, create, update, delete namespaces, and validate namespace IDs."
    },
    {
      "name": "Nacos Console Configuration History Related APIs",
      "description": "Operations related to configuration history versions in the Nacos Console Configuration Center, including retrieving historical version lists, viewing details of historical versions, and more."
    },
    {
      "name": "Nacos Console Service Instance Related APIs",
      "description": "Operations related to service instances in the Nacos Naming Center, including retrieving instance lists and updating instance metadata."
    },
    {
      "name": "Nacos Console State-related APIs",
      "description": "Retrieve the Nacos console's state, announcements, and guidance content."
    },
    {
      "name": "Nacos Console Cluster APIs",
      "description": "Routines to retrieve cluster information for the Nacos-controlled cluster."
    },
    {
      "name": "Nacos Console Configuration Center Related APIs",
      "description": "Nacos Console operations for the configuration center, including retrieving configuration lists, fetching configuration details, publishing configurations, deleting configurations, batch deletion, searching configurations, listening for configuration changes, exporting configurations, importing configurations, and more."
    },
    {
      "name": "Nacos Console Health Check APIs",
      "description": "Routines to check the health status of the Nacos console."
    }
  ],
  "paths": {
    "/v3/console/ns/service": {
      "get": {
        "tags": [
          "Nacos Console Naming Center Service Related APIs"
        ],
        "summary": "Retrieve Service Details",
        "description": "This interface retrieves detailed information of a specified service, including metadata and configuration.",
      ...
      "put": {
        ...
        "description": "This interface updates metadata of a service (e.g., `metadata`, `selector`). Immutable fields include `serviceName`, `groupName`, and `namespaceId`.",
      ...
      "post": {
        ...
        "description": "This interface creates an empty service.",
      ...
      "delete": {
        ...
        "description": "This interface deletes a service. Note: This is service deletion, NOT instance deletion. A service cannot be deleted if it has existing service instances.",
    ...
    "/v3/console/ns/service/cluster": {
      "put": {
        ...
        "summary": "Update Service Cluster Metadata",
        "description": "This interface updates metadata for a specific service cluster.",
    ...
    "/v3/console/ns/instance": {
      "put": {
        "tags": [
          "Nacos Console Service Instance Related APIs"
        ],
        "summary": "Update Instance Metadata",
        "description": "This interface updates metadata of specified service instances (e.g., `weight`, `enabled`). Unmodifiable fields include `serviceName`, `groupName`, `namespace`, `IP`, and `port`.",
    ...
    "/v3/console/core/namespace": {
      "get": {
        "tags": [
          "Nacos Console Namespace APIs"
        ],
        "summary": "Get namespace details",
        "description": "Renders detailed information of a specific namespace.",
      ...
      "put": {
        ...
        "description": "Updates non-ID attributes of a namespace (e.g., name, description). The namespace ID itself cannot be modified.",
      ...
      "post": {
        ...
        "description": "Creates a new namespace with a custom ID and metadata.",
      ...
      "delete": {
        ...
        "description": "Deletes a namespace. The default `public` namespace cannot be deleted.",
    ...
    "/v3/console/cs/config": {
      "get": {
        "tags": [
          "Nacos Console Configuration Center Related APIs"
        ],
      ...
      "post": {
        ...
        "description": "This interface enables the creation of new configurations or updating existing ones.",
      ...
      "delete": {
        ...
        "description": "This interface deletes the specified configuration.",
    ...
    "/v3/console/cs/config/clone": {
      "post": {
        ...
        "summary": "Clone Configurations",
        "description": "This interface clones selected or queried configurations into other namespaces.",
    ...
    "/v3/console/server/state": {
      "get": {
        "tags": [
          "Nacos Console State-related APIs"
        ],
        "summary": "Get cluster status information",
        "description": "This interface retrieves the Nacos cluster's foundational status and configuration, such as version number, operational mode, and authentication status. It does not return node-level cluster details.",
    ...
    "/v3/console/server/guide": {
      "get": {
        ...
        "summary": "Get console guidance content",
        "description": "This interface retrieves guidance information for the Nacos console. The default console UI calls this interface when the console is disabled to fetch guidance content, as detailed in the console manual's \"Disable Default Console\" section.",
    ...
    "/v3/console/server/announcement": {
      "get": {
        ...
        "summary": "Get console announcement information",
        "description": "This interface retrieves announcements to be displayed in the browser by the Nacos console. By default, the console UI calls this interface when authentication is not enabled to return a security warning.",
              ...
              "application/json": {
                "schema": {
                  ...
                  "example": {
                    "code": 0,
                    "message": "success",
                    "data": "Authentication has not been enabled in cluster, please refer to <a href=\"https://nacos.io/en/docs/latest/manual/admin/auth/\">Documentation</a> to enable~"
                  }
                }
              }
            }
    ...
    "/v3/console/ns/service/subscribers": {
      "get": {
        ...
        "summary": "List Service Subscribers",
    ...
    "/v3/console/ns/service/selector/types": {
      "get": {
        ...
        "summary": "List Supported Service Selectors",
        "description": "This interface retrieves the list of supported service selectors to populate the dropdown in the console UI during service creation/update.",
    ...
    "/v3/console/health/readiness": {
      "get": {
        "tags": [
          "Nacos Console Health Check APIs"
        ],
        "summary": "Get Nacos console readiness status",
        "description": "This interface checks if the Nacos console is ready to read data from the cluster.",
    ...
    "/v3/console/health/liveness": {
      "get": {
        ...
        "summary": "Get Nacos console liveness status",
        "description": "This interface checks if the Nacos console is operational and able to respond to requests.",
    ...
    "/v3/console/cs/history": {
      "get": {
        "tags": [
          "Nacos Console Configuration History Related APIs"
        ],
        "summary": "Retrieve a Specific Configuration History Change Record",
    ...
    "/v3/console/cs/history/previous": {
      "get": {
        ...
        "summary": "Retrieve Previous Change History Before the Latest Version",
        "description": "This interface retrieves the most recent change history before the current latest version of the configuration.",
    ...
    "/v3/console/cs/history/list": {
      "get": {
        ...
        "summary": "List Configuration Publish History",
    ...
    "/v3/console/cs/history/configs": {
      "get": {
        ...
        "summary": "List Configurations Under a Namespace",
        "description": "This interface retrieves a list of configurations under a specified namespace, returning only `dataId` and `groupName` fields for use in UI dropdown menus.",
    ...
    "/v3/console/cs/config/searchDetail": {
      "get": {
        ...
        "summary": "Search Configurations by Content",
        "description": "This interface searches for configurations based on their content. **Note: This interface has lower performance; frequent use may cause stability issues. Use other interfaces whenever possible.**",
    ...
    "/v3/console/cs/config/listener": {
      "get": {
        ...
        "summary": "List Configuration Listeners",
    ...
    "/v3/console/cs/config/listener/ip": {
      "get": {
        ...
        "summary": "Query Configurations Subscribed by an IP",
    ...
    "/v3/console/cs/config/export2": {
      "get": {
        ...
        "description": "This interface exports selected or queried configurations as a ZIP file for backup or migration to another Nacos cluster. ** Note: Use either ids or dataId + groupName combinations exclusively. Mixing parameters may result in an empty ZIP file. **",
    ...
    "/v3/console/cs/config/beta": {
      "get": {
        ...
        "summary": "Check Beta Release Status of a Configuration",
        "description": "This interface checks whether a configuration is in a beta release state. **Note: Only valid for configurations marked as beta releases with the betaIps header during publishing.**",
      ...
      "delete": {
        ...
        "summary": "Terminate Configuration Beta Release Status",
        "description": "This interface stops a configuration's beta release by reverting its beta status. **Note: Only applicable if the configuration was marked for beta release with the betaIps header during publishing.**",
    ...
    "/v3/console/core/namespace/exist": {
      "get": {
        ...
        "summary": "Validate namespace existence",
        "description": "Verifies if a namespace ID exists. This is used by the console during namespace creation to prevent ID conflicts.",
    ...
    "/v3/console/core/cluster/nodes": {
      "get": {
        "tags": [
          "Nacos Console Cluster APIs"
        ],
        "summary": "Get runtime information of Nacos nodes",
        "description": "This interface retrieves operational details of Nacos nodes, including node IP addresses, status, and metadata.",
    ...
    "/v3/console/cs/config/batchDelete": {
      "delete": {
        ...
        "description": "This interface allows for the deletion of multiple specified configurations.",
